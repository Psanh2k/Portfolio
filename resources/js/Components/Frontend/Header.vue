...
<nav class="bg-light-primary border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-dark-primary">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    <a href="/" class="flex items-center">
        ...
        <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Veggie Saigon</span>
    </a>
    ...
    :class="{hidden: showMobileMenu}"
     id="navbar-default">
      <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-light-tail-500 dark:border-dark-navy-100 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:border-0 dark:border-gray-700">
        <li>
          <a href="#" class="block py-2 pl-3 pr-4 text-white bg-light-tail-500 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white md:dark:bg-dark-navy-100" aria-current="page">Home</a>
        </li>
        <li>
